...
<html lang="en-US" class="no-js no-svg">
  ...
  <head>
    ...
    <style id="cspt-dynamic-style-inline-css">
      .cspt-title-bar-wrapper {
        background-image: url(../wp-content/uploads/2020/05/header-bg.jpg) !important;
      }
      .cspt-title-bar-wrapper:before {
        opacity: 0.5 !important;
      }
      .vc_custom_1591609909935:before {
        background-image: none !important;
      }
      .vc_custom_1558503995912:before {
        background-image: none !important;
      }
      .vc_custom_1590219109370:before {
        background-image: none !important;
      }
      @media (max-width: 991px) {
        .cspt-column.cspt-responsive-custom-75812167 > .vc_column-inner {
          padding-left: 15px !important;
        }
      }
      @media (max-width: 767px) {
        .cspt-column-inner.cspt-responsive-custom-75758661 > .vc_column-inner {
          margin-top: 25px !important;
          margin-bottom: 25px !important;
        }
      }
      .vc_custom_1590166749888:before {
        background-image: none !important;
      }
      .vc_custom_1590166774588:before {
        background-image: none !important;
      }
      .vc_custom_1590166788202:before {
        background-image: none !important;
      }
      .vc_custom_1590166797904:before {
        background-image: none !important;
      }
    </style>
    <link
    ...
    <link
      ...
      href="../wp-content/plugins/js_composer/assets/lib/bower/font-awesome/css/all.min9b2d.css?ver=6.1"
      type="text/css"
      media="all"
    />
    ...
    <link rel="shortlink" href="../index9add.html?p=8549" />
    <link
      rel="alternate"
      type="application/json+oembed"
      href="../wp-json/oembed/1.0/embed25d8.json?url=https%3A%2F%2Fcomplyatease.co.za%2Fabout-us-2%2F"
    />
    <link
      rel="alternate"
      type="text/xml+oembed"
      href="../wp-json/oembed/1.0/embedda84?url=https%3A%2F%2Fcomplyatease.co.za%2Fabout-us-2%2F&amp;format=xml"
    />
    <style>
    ...
    <style data-type="vc_shortcodes-custom-css">
      ...
      .vc_custom_1590166749888 {
        padding-top: 0px !important;
        padding-bottom: 0px !important;
      }
      .vc_custom_1590166774588 {
        padding-bottom: 10px !important;
      }
      .vc_custom_1590166788202 {
        padding-top: 0px !important;
      }
      .vc_custom_1590166797904 {
        padding-top: 10px !important;
        padding-bottom: 30px !important;
      }
      .vc_custom_1591609943382 {
        padding-bottom: 10px !important;
      }
      .vc_custom_1590219109370 {
        margin-top: -20px !important;
        padding-top: 100px !important;
        padding-bottom: 90px !important;
        padding-left: 55px !important;
      }
      .vc_custom_1590166533422 {
        margin-top: -60px !important;
      }
      .vc_custom_1553923029977 {
        padding-bottom: 20px !important;
      }
      .vc_custom_1591610280276 {
        margin-top: 50px !important;
      }
      .vc_custom_1556606145343 {
  ...
  <body
    class="page-template-default page page-id-8549 cspt-sidebar-no wpb-js-composer js-comp-ver-6.1 vc_responsive"
  >
              ...
              <div class="cspt-title-bar-content-inner">
                <div class="cspt-tbar">
                  <div class="cspt-tbar-inner container">
                    <h1 class="cspt-tbar-title">About Us</h1>
                  </div>
                </div>
        ...
        <div id="content" class="site-content container">
          <div id="primary" class="content-area">
            <main id="main" class="site-main cspt-page-content-wrapper">
              <article
                id="post-8549"
                class="post-8549 page type-page status-publish hentry"
              >
                <div class="entry-content">
                  <div
                    class="vc_row wpb_row vc_row-fluid vc_custom_1591609909935 cspt-row cspt-bg-color-yes cspt-bg-color-transparent cspt-zindex-zero"
                  >
                    <div
                      class="wpb_column vc_column_container vc_col-sm-12 cspt-column cspt-bg-color-yes cspt-bg-color-transparent cspt-zindex-zero"
                    >
                      <div class="vc_column-inner">
                        <div class="wpb_wrapper">
                          ...
                          <h2
                            style="color: #002e5b; text-align: left"
                            class="vc_custom_heading vc_custom_1591609943382"
                          >
                            Who We Are
                          </h2>
                          <div class="wpb_text_column wpb_content_element">
                            <div class="wpb_wrapper">
                              <p>
								Comply at Ease Pty Ltd is a specialist business consulting firm offering business specific  Tax and Advisory Services, 
								Company Secretarial Services and Accounting Services targeting small to medium businesses in South Africa. 
								Located in Johannesburg, Gauteng, we are serious about giving your organisation cutting-edge and tailor-made business solutions because we simply know how. 
								Our senior management has a combined 25 years experience in Tax administration and advisory, 
								Company Secretarial and Accounting services in various sectors.
                              </p>
                            </div>
                          </div>
                          <div class="vc_empty_space" style="height: 32px">
                  ...
                  <div
                    ...
                    class="vc_row wpb_row vc_row-fluid cspt-overflow-visible vc_custom_1558503995912 cspt-row cspt-text-color-yes cspt-text-color-white cspt-bg-color-yes cspt-bg-color-blackish cspt-zindex-1 cspt-responsive-custom-65391859 cspt-break-col-991"
                  >
                    <div
                      class="wpb_column vc_column_container vc_col-sm-6 cspt-column cspt-bg-color-yes cspt-bg-color-transparent cspt-zindex-2"
                     >
                      <div class="vc_column-inner">
                        <div class="wpb_wrapper">
                          <div
                            class="wpb_single_image wpb_content_element vc_align_left vc_custom_1590166533422"
                          >
                            <figure class="wpb_wrapper vc_figure">
                              ...
                              >
                                <img
                                  ...
                                  src="../wp-content/uploads/2018/12/post1-565x642.jpg"
                                  width="565"
                                  height="642"
                                  alt="post1"
                                  title="post1"
                    ...
                    <div
                      class="wpb_column vc_column_container vc_col-sm-6 cspt-column cspt-bg-color-yes cspt-bg-color-transparent cspt-zindex-zero cspt-responsive-custom-75812167"
                    >
                      <div class="vc_column-inner vc_custom_1590219109370">
                        <div class="wpb_wrapper">
                          <div
                          ...
                          <div class="wpb_text_column wpb_content_element">
                            <div class="wpb_wrapper">
                              <p>
								We blend our collective experience with our quest for excellence to deliver enduring results for all our clients with hope that our clients build sustainable businesses. 
								Our dynamic consultants will utilize their in-depth knowledge to take care of the legal jargon whilst you concentrate on what you know best – running your company.
                              </p>
                            </div>
                          </div>
                        </div>
                  ...
                  <div
                    class="vc_row wpb_row vc_row-fluid cspt-row cspt-bg-color-yes cspt-bg-color-white cspt-zindex-zero"
                  >
                    <div
                      class="wpb_column vc_column_container vc_col-sm-12 cspt-column cspt-bg-color-yes cspt-bg-color-transparent cspt-zindex-zero"
                    >
                      <div class="vc_column-inner">
                        <div class="wpb_wrapper">
                          <div
                            class="cspt-ihbox cspt-ihbox-style-hsbox vc_custom_1553923029977 cspt-reverse-heading-yes cspt-align-center vc_custom_1553923029977"
                          >
                            <div class="cspt-ihbox-contents">
                              <div class="cspt-ihbox-heading">
                                <h2 class="vc_custom_heading">
                          ...
                          <div
                            class="vc_row wpb_row vc_inner vc_row-fluid cspt-steps-counter cspt-row-inner cspt-bg-color-yes cspt-bg-color-transparent cspt-zindex-zero"
                          >
                            <div
                              class="wpb_column vc_column_container vc_col-sm-4 cspt-column-inner cspt-bg-color-yes cspt-bg-color-transparent cspt-zindex-zero"
                            >
                              <div class="vc_column-inner">
                                <div class="wpb_wrapper">
                                  <div class="cspt-ihbox cspt-ihbox-style-5">
                                    <div class="cspt-ihbox-contents">
                                      ...
                                      <div class="cspt-ihbox-content">
                                        Book with us via call or email
                                      </div>
                                    </div>
                                    <!-- .cspt-ihbox-contents -->
                                  </div>
                            ...
                            <div
                              class="wpb_column vc_column_container vc_col-sm-4 cspt-column-inner cspt-bg-color-yes cspt-bg-color-transparent cspt-zindex-zero cspt-responsive-custom-75758661"
                            >
                              <div class="vc_column-inner">
                                <div class="wpb_wrapper">
                                  <div class="cspt-ihbox cspt-ihbox-style-5">
                                    <div class="cspt-ihbox-contents">
                                      ...
                                      <div class="cspt-ihbox-content">
                                        we discuss, our service and hear your terms
                                      </div>
                                    </div>
                                    <!-- .cspt-ihbox-contents -->
                                  </div>
                                ...
                                <div class="wpb_wrapper">
                                  <div class="cspt-ihbox cspt-ihbox-style-5">
                                    <div class="cspt-ihbox-contents">
                                      ...
                                      <div class="cspt-ihbox-content">
                                        with our recipe we deliver the product to you
                                      </div>
                                    </div>
                                    <!-- .cspt-ihbox-contents -->
                                  </div>
                          ...
                          <div
                            class="vc_btn3-container vc_btn3-center vc_custom_1591610280276"
                          >
                            <button
                              class="vc_general vc_btn3 vc_btn3-size-md vc_btn3-shape-square vc_btn3-style-outline vc_btn3-icon-right vc_btn3-color-globalcolor"
                            >
                              <span
                                >Contact Us <i class="vc_btn3-icon"></i
                              ></span>
                            </button>
                          </div>
                        </div>
